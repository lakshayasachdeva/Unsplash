...
class SearchResultInteractor: SearchResultScreenInputInteractorProtocol {
    
    var presenter: SearchResultScreenOutputInteractorProtocol?
    ...
    private func checkIfFiltersBeingReset(forFilters currentFilter:[FilterModel]) -> Bool{
